...
async def main():
    ...
    geth_command = f'geth --datadir {chain_dir} --nodiscover --http --http.addr 0.0.0.0 --http.corsdomain "*" --http.api eth,net,web3,debug --networkid {chain_num} {miner_settings}'
    print(geth_command)
